...
2. How would you explain form validation to someone who has never programmed before?
    ...
    Validations let the users know if they are inputting incorrect information or if they are missing something. Without them, they would not know why their page is not working.

3. In 1-2 sentences, define end to end testing.

    End-to-End testing makes sure everything in the webpage is working as it should. It simulates the interactions that a normal user would make and helps developers make sure there are no bugs in the code.
